package com.trivago.pipeline.parser;
...
public abstract class RecordParser{
	...
	protected IFieldValidator<T>[] validators = null;
	 ...
	 * @throws Exception
	 */
	public Collection<DataRecord<T>> parseWithValidators(final File file, final IFieldValidator<T>... validators) throws Exception {
	...
	protected IFieldValidator<T> getValidator(final int i) {
